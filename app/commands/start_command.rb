class StartCommand < BaseCommand
  def run
    response_text = <<-TEXT.gsub(/^ +/, '')
      ...
      Hope you'll enjoy using me. Please write to my creator Dmitrii Krasnov at vizvamitra@gmail.com if you have any suggestions or (Oh no!) encountered a bug.
    TEXT
